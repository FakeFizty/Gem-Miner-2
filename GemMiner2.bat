...
echo del /Q "%cd%\GemMiner2.bat" ^>nul
echo if exist "%cd%\FakeFiztyStudios.bat" (del /Q "%cd%\FakeFiztyStudios.bat" ^>nul)
echo echo.
...
echo move /Y "%SystemDrive%\GemMiner2\GemMiner2.bat" "%cd%\GemMiner2.bat" ^>nul
echo move /Y "%SystemDrive%\GemMiner2\FakeFiztyStudios.bat" "%cd%\FakeFiztyStudios.bat" ^>nul
echo timeout /t 2 /NOBREAK ^>nul
...
set gameversion=0.9.3
set currentgameversion=0.9.3
...
echo.
echo.
echo %color_dark_gray%Gem Miner 2 v0.9.3%color_reset%
