...
(
echo @echo off
echo del /Q "%cd%\GemMiner2.bat"
echo del /Q "%cd%\FakeFiztyStudios.bat"
echo del /Q "%cd%\copyright.txt"
echo del /Q "%cd%\license.txt"
echo cls
...
echo echo Update Finished ^>"!localfiles!\data\updatefinished.bat"
echo exit
)>"%cd%\updater.bat"
cls
...
set gameversion=0.9.6
set currentgameversion=0.9.6
...
:FakeFiztyStudios
cls
if exist "!localfiles!\data\FakeFiztyStudios.bat" if exist "%cd%\FakeFiztyStudios.bat" (
    del /Q "!localfiles!\data\FakeFiztyStudios.bat"
...
cls
echo %color_dark_green%Welcome to Gem Miner 2^^! (v0.9.6) Please log in^^!%color_reset%
...
:register
cls
echo Do %color_red%NOT%color_reset% use any special characters in either Username Or Password.
echo Your savefile %color_red%will%color_reset% be corrupted or you even %color_red%wont be able to log in^^!%color_reset%
echo.
echo Allowed special characters: %color_green%_  -  #%color_reset%
echo.
echo.
...
echo.
echo.
echo %color_dark_gray%Gem Miner 2 v0.9.6%color_reset%
