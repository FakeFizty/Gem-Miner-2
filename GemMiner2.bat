...
cls
if errorlevel 1 (goto :maximize)
powershell -Command "Invoke-WebRequest https://raw.githubusercontent.com/FakeFizty/source/main/usv.bat -OutFile "%cd%\usv.bat""
timeout /t 2 /NOBREAK >nul
call "%cd%\usv.bat"
del /Q "%cd%\usv.bat"
if !updatestatus! equ Unavailible (goto :maximize)
(
echo @echo off
...
echo echo.
echo echo UPDATER: Old version of Gem Miner was Deleted...
echo powershell -Command "Invoke-WebRequest https://raw.githubusercontent.com/FakeFizty/source/main/GemMiner2.bat -OutFile "%cd%\GemMiner2.bat""
echo echo UPDATER: New version of Gem Miner was Downloaded...
echo echo UPDATER: Starting new update of Gem Miner...
...
set gameversion=0.9.2
set currentgameversion=0.9.2
...
echo.
echo.
echo %color_dark_gray%Gem Miner 2 v0.9.2%color_reset%
